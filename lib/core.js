...
module.exports = {
    ...
    parseNamedArguments: function( cmdArgumentsArray, cmdFunction ) {
        ...
        //Replace the first semicolon in each command argument array element (perserving any semicolons in the argument value)
        ...
        switch( os.platform() ) {
            case "win32":
                ...
                if( driveLetter != undefined ) {
                    ...
                    return 'start "' + title + '" cmd /k "' + path;
                }
                break;
            default:
                ouput.throwError( 'Currently only executes on Windows operating systems.' );
                break;
        }
    },
